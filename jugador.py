...
class Jugador():
    ...
    def enviarMensaje(self, mensaje, comandos = [], jugadores= [], banca = [], mano = [], finalizado = False, ganadores = []):
        self.usuario.enviarMensaje("[Servidor] " + mensaje, comandos, jugadores, banca, mano, finalizado, ganadores)
